...
tracking_csv = Path("Gemini/tracking/gemini_results_first.csv")
...
2) insiders — each row has:
  ...
  b6: Title and Position with Bank Holding Company (list, if multiple)
  b7: Title and Position with direct and indirect subsidiaries (including the subsidiaries' names. List all, if multiple)
  b8: Title and Position with any other company in which the person is a director, trustee, partner, or executive officer (list, if multiple)
